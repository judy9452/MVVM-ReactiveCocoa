...
-(void)setDefaultProperties:(NSString *)showPic
{
    ...
    if ([showPic isEqualToString:@"small"])
    {
        self.starImage = [UIImage imageNamed:@"icon_store_smallstar_gray"];
        self.starHighlightedImage = [UIImage imageNamed:@"icon_store_smallstar_yellow"];
    }
    else
    {
        self.starImage = [UIImage imageNamed:@"icon_store_bigstar_gray"];
        self.starHighlightedImage = [UIImage imageNamed:@"icon_store_bigstar_yellow"];
    }
}
#if  EDSTAR_MACOSX
